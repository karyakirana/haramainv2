<x-metronics-layout>
    ...
    <x-organism.card :title="__('Stock Opname')">
        <x-slot name="header">
            <button type="button" class="btn btn-primary align-self-center" onclick="stockOpnameAdd()">New Data</button>
        </x-slot>
    ...
    @push('custom-scripts')
        <script>
            ...
            var dataOpname = function (){
                ...
                var initDatatable = function(){
                    dt = $("#stockOpnameDatatables").DataTable({
                        ...
                        ajax : {
                            url : "{{route('datatables.stockopname.baik')}}",
                            method : 'PATCH',
                        },
                        columns : [
                            {data:'kode'},
            ...
            function stockOpnameAdd()
            {
                window.location.href = "{{route('stockopname.baik.trans')}}";
            }


            function edit(id)
            {
                window.location.href = "{{url('/').'/stock/opname/baik/edit/'}}"+id;
            }
