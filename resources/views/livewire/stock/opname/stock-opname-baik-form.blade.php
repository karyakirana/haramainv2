<div>
    ...
    <x-organism.card :title="__('Stock Masuk Baik Transaksi')">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-4">
                            <div class="input-group">
                                <x-atom.input-form wire:model.defer="pegawai_id" readonly/>
                                <button type="button" class="btn btn-primary" wire:click="showPegawai">Get</button>
                                <x-atom.input-message :name="__('$pegawai_id')" />
                            </div>
                        </div>
                        <label class="col-2 col-form-label">Tgl Input</label>
                        <div class="col-4">
                            <x-atom.input-singledaterange id="tgl_input" wire:model.defer="tgl_input" readonly />
                            <x-atom.input-message :name="__('tgl_input')" />
                        </div>
                    </div>
                    <div class="row mb-4">
        ...
        <x-slot name="footer">
            ...
            @else
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-primary" wire:click="store" href="{{ route('stockopname.baik.index') }}">Save All</button>
                </div>
            @endif
        </x-slot>
