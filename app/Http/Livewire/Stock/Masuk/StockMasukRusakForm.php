...
class StockMasukRusakForm extends Component
{
    protected $listeners = [
        'setProduk'=>'setProduk',
        'setUser'=>'setUser',
...
//            dd($stockMasuk->supplier);
    ...
    public function updateLine()
    {
        ...
        $this->dataDetail[$index]['kondisi'] = 'rusak';
...
//        dd($dataStockMasuk);
    public function store()
    {
        ...
        return redirect()->to('stock/masuk/rusak');
    ...
    {
        return view('livewire.stock.masuk.stock-masuk-rusak-form');
    }
}
