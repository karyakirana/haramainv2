...
class PenjualanForm extends Component
{
    ...
    public function mount($penjualan = null)
    {
        ...
        if ($penjualan){
            ...
            $this->tgl_tempo = ($penjualan->jenis_bayar == 'tempo') ? tanggalan_format($penjualan->tgl_tempo) : tanggalan_format(strtotime("+2 months", strtotime($penjualan->tgl_nota))) or null;
