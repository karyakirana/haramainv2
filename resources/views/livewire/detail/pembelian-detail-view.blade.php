<div>
    <x-organism.modal :title="__('Detail Pembelian')" :tipe="__('xl')" id="detailModal"  wire:ignore.self>
        <form id="detailModal">
            <div class="form-group row">
                ...
                <div class="col-2">
                    <p class="form-control-plaintext">{{$jenis_bayar??''}}</p>
                </div>
            </div>
            <div class="form-group row">
        ...
        <table class="table table-row-bordered table-bordered gx-5">
            ...
            <tbody>
            @isset($detailPembelian)
                @forelse($detailPembelian as $row)
                    <tr class="border">
            ...
            <tr>
                ...
                <td class="text-end">
                    @isset($detailPembelian)
                        {{ rupiah_format($detailPembelian->sum('sub_total')) }}
                    @endisset
                </td>
            </tr>
            <tr>
