<x-metronics-layout>
    ...
    <x-organism.card :title="__('Mutasi Stock Baik ke Rusak')">
        <x-slot name="header">
    ...
    @push('custom-scripts')
        <script>
            ...
            var dataCustomer = function (){
                ...
                var initDatatable = function(){
                    dt = $("#penjualanDatatables").DataTable({
                        ...
                        ajax : {
                            url : "{{route('datatables.mutasi.baik.rusak')}}",
                            method : 'PATCH',
                        },
                        columns : [
                            {data:'kode'},
            ...
            function mutasiAdd()
            {
                window.location.href = "{{route('mutasibaik.rusak.trans')}}";
            }

            function edit(id)
            {
                window.location.href = "{{url('/').'/stock/mutasi/baik/rusak/edit/'}}"+id;
            }
