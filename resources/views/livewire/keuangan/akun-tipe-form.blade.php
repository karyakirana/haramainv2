<div>
    <x-organism.modal :title="__('Form Tipe')" :tipe="__('lg')" id="formModal"  wire:ignore.self>
        <form id="form">
            <div class="row mb-6">
                <label for="idCustomer" class="col-sm-4 col-form-label">Kode</label>
                <div class="col-8">
                    <x-atom.input-form :name="__('kode')" wire:model.defer="kode"/>
            ...
            <div class="row mb-6">
                ...
                <div class="col-8">
                    <x-atom.input-form :name="__('deskripsi')" wire:model.defer="deskripsi"/>
