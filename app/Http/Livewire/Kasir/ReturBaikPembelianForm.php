...
use App\Http\Services\Repositories\PembelianReturRepository;
...
class ReturBaikPembelianForm extends Component
{
    public function render()
    {
        return view('livewire.kasir.retur-baik-pembelian-form')->layout('layouts.metronics');
    }
    ...
    public function mount($retur = null)
    {
        ...
        if ($retur){
            ...
            $this->tgl_tempo = ($retur->jenis_bayar == 'tempo') ? tanggalan_format($retur->tgl_tempo) : null ;
    ...
    public function store()
    {
        ...
        DB::beginTransaction();
        try {
            $idRetur = (new PembelianReturRepository())->store($dataPenjualan);
        } catch (ModelNotFoundException $e) {
            DB::rollBack();
            session()->flash('message', $e);
        }
        return redirect()->to('kasir/pembelian/retur/baik');
    }
