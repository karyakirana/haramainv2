...
class RusakRusakForm extends Component
{
    protected $listeners = [
        'setProduk'=>'setProduk'
    ];
...
//        dd($dataStockMutasi);
    public function store()
    {
        ...
        return redirect()->to('stock/mutasi/rusak/rusak');
    }
    ...
    {
        return view('livewire.stock.mutasi.rusak-rusak-form');
    }
}
