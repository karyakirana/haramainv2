<div>
    ...
    <x-organism.card :title="__('Pembelian Transaksi')">
        <div class="row">
            <div class="col-8">
                <form id="formMaster">
                    <div class="row mb-4">
                        ...
                        <div class="col-4">
                            <div class="input-group">
                                <input type="text" class="form-control @error('supplier_nama') is-invalid @enderror " id="supplier" wire:model.defer="supplier_nama">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#daftar-supplier"><i class="fas fa-user"></i></button>
        ...
        <x-organism.modal :tipe="__('xl')" :title="__('Data Supplier')" id="daftar-supplier">
    ...
    @push('custom-scripts')
        <script>
            ...
            var modalSupplier = new bootstrap.Modal(document.getElementById('daftar-supplier'), {
                keyboard : false
            })

            Livewire.on('setSupplier', ()=>{
                modalSupplier.hide()
            });
        </script>
    @endpush
